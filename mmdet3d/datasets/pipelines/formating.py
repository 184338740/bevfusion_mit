...
class Collect3D:
    ...
    def __call__(self, results):
        ...
        """
        if Debug:
            print(f">>>[xmy]🟡[formating.py] >>> Collect3D.__call__() >>>  self.keys = { self.keys}")
            print(f">>>[xmy]🟡[formating.py] >>> Collect3D.__call__() >>>  self.meta_keys = { self.meta_keys}")
            print(f">>>[xmy]🟡[formating.py] >>> Collect3D.__call__() >>>  self.meta_lis_keys = { self.meta_lis_keys}")
        ...
        if Debug:
            print(f">>>[xmy]🟡[formating.py] >>> Collect3D.__call__() >>> data.keys()= { data.keys()}")
            print(f">>>[xmy]🟡[formating.py] >>> Collect3D.__call__() >>> data['metas'] = { data['metas']}")   
        return data
