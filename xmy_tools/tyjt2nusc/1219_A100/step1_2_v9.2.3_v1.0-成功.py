...
4. 处理激光雷达数据（npy→bin转换）：
    ...
    npy是6维,而目标bin是5维，因此用 convert_npy_to_bin 实现裁剪转换 points_5d = point_cloud[:, :5].astype(np.float32)
...
if Mode == "Local":
    ...
    ANALYSIS_ROOT = "./output-1226-v9.2.3-sub/step1/nuscenes_tyjt/analysis"
    NUSC_VERSION = "v1.0-tyjt"
    DATA_PACKAGE_CONFIG = {
        "2d3d_20250114": {
            "type": "hikvision",
    ...
    ANALYSIS_ROOT = "./output-1226-v9.2.3-all/step1/nuscenes_tyjt/analysis"
    NUSC_VERSION = "v1.0-tyjt"
