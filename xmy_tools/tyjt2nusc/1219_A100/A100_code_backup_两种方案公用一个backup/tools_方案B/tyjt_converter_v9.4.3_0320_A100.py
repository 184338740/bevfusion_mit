...
# ==================== 全局配置 ====================
DatasetInfos = "A100_all" # infos可以是个全集，只是个信息，
...
def main():
    ...
    parser.add_argument("--data-root", type=str, default="/mnt/dataset/tyjt_RawData_all",
                        help="TYJT 数据集根目录")
    parser.add_argument("--train-split", type=str, default=f"../datasets/tyjt2pkl/tyjt_data_infos/tyjt_train.txt",
                        help="训练集划分文件")
    parser.add_argument("--val-split", type=str, default=f"../datasets/tyjt2pkl/tyjt_data_infos/tyjt_val.txt",
                        help="验证集划分文件")
    parser.add_argument("--out-dir", type=str, default=f"../datasets/tyjt2pkl/tyjt_data_infos",
                        help="输出 pkl 文件的目录")
    ...
    # 构建带 metadata 的完整结构
    metadata = {
        "version": 'A100_V031_sub',  #"v03-tyjt",
