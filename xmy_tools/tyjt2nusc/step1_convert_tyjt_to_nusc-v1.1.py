...
def transform_sensor_to_ego(sensor_calib, group2map_calib):
    ...
    sensor_trans = np.array([sensor_calib['tx'], sensor_calib['ty'], sensor_calib['tz']]) / 100.0  # cm转m
