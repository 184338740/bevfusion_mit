...
def analyze_pkl_files():
    ...
    if Mode == "Local":
        ...
        pkl_root = "./output/step1/nuscenes_tyjt"
    elif Mode == "A100":
        nusc_root = "./output/step1-1127/nuscenes_tyjt"
        pkl_root = "./output/step3_pkl-v1127"
    else:
        print("❌ Mode配置错误")
        return
    
    print("🔍 开始分析tyjt数据集pkl文件")
    print("=" * 80)
    ...
    for file_name, file_path in pkl_files.items():
        ...
        try:
            ...
            if file_name == 'dbinfos_train':
                analyze_dbinfos_file_fixed(data, file_name, standard_categories)
            elif 'infos' in file_name:
                analyze_infos_file_fixed(data, file_name, standard_categories)
            else:
...
def analyze_infos_file_fixed(data, file_name, standard_categories):
    """修复版分析infos文件"""
    print(f"  数据类型: {type(data)}")
...
def analyze_dbinfos_file_fixed(data, file_name, standard_categories):
    """修复版分析dbinfos文件"""
    print(f"  数据库信息:")
