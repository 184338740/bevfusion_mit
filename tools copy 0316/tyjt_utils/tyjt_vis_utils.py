...
# def generate_bev_image(points: np.ndarray, boxes_3d: List[Dict], base_name: str,
#                        out_dir: Path, x_range=(-100, 100), y_range=(-100, 100),
#                        point_size=BEV_POINT_SIZE, alpha=BEV_POINT_ALPHA,
#                        downsample=BEV_POINT_CLOUD_DOWNSAMPLE) -> None:
#     """
#     生成 BEV 点云图，带网格和刻度，保存为 {base_name}_BEV.jpg。
#     参数：
#         points: (N, 3) 点云数组
#         boxes_3d: 3D 框列表，每个框包含 'center', 'size', 'yaw'
#         base_name: 文件名前缀
#         out_dir: 输出目录
#         x_range, y_range: 显示范围
#         point_size, alpha, downsample: 绘图参数
#     """
#     fig, ax = plt.subplots(1, 1, figsize=(12, 12), dpi=150)
